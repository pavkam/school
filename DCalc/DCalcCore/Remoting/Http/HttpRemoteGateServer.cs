...
{
    public class HttpRemoteGateServer<L> : IRemoteGateServer 
        where L : ILoadBalancer, new()
    {
        ...
        /* Threading */
        private String m_SyncRoot = "HttpRemoteGateServer Sync";
        ...
        private void WriteResponse(HttpListenerContext context, XPortCommBody body)
        {
        ...
        private void WriteResponse(HttpListenerContext context, String code, String content)
        {
        ...
        /// <param name="context">The context.</param>
        /// <returns></returns>
        private String GetBody(HttpListenerContext context)
        {
            Stream stream = context.Request.InputStream;

            /* Read stream contents */
            Int32 countRemaining = (Int32)context.Request.ContentLength64;
            Int32 countRead = 0;
            Byte[] streamContent = new Byte[countRemaining];

            while (countRead != countRemaining)
            {
                countRead += stream.Read(streamContent, countRead, streamContent.Length - countRead);
            }

            /* Transform back to string */
            String responseString = Encoding.UTF8.GetString(streamContent);
        ...
        /// </summary>
        /// <param name="context">The context.</param>
        private void Operation_HELLO(HttpListenerContext context)
        {
        ...
        private void Operation_REGISTER(HttpListenerContext context, String securityKey)
        {
        ...
        private void Operation_UNREGISTER(HttpListenerContext context, String clientId)
        {
            ...
            foreach (String key in keys)
            {
                ...
                Operation_UNLOAD(context, clientId, key);
            }
        ...
        /// <param name="context">The context.</param>
        /// <param name="clientId">The client id.</param>
        private void Operation_LOAD(HttpListenerContext context, String clientId)
        {
            lock (m_SyncRoot)
            {
                UniqueCollection<IScript> scriptCollection = m_RegisteredClients[clientId];
        ...
        private void Operation_UNLOAD(HttpListenerContext context, String clientId, String scriptId)
        {
        ...
        /// <param name="clientId">The client id.</param>
        /// <param name="scriptId">The script id.</param>
        private void Operation_DATAIN(HttpListenerContext context, String clientId, String scriptId)
        {
            lock (m_SyncRoot)
            {
                UniqueCollection<IScript> scriptCollection = m_RegisteredClients[clientId];
        ...
        /// <param name="clientId">The client id.</param>
        /// <param name="scriptId">The script id.</param>
        private void Operation_DATAOUT(HttpListenerContext context, String clientId, String scriptId)
        {
            lock (m_SyncRoot)
            {
                UniqueCollection<IScript> scriptCollection = m_RegisteredClients[clientId];
        ...
        /// </summary>
        /// <param name="context">The context.</param>
        private void ServeClient(HttpListenerContext context)
        {
            /* Check for validity */
            ...
            try
            {
                String operation = context.Request.QueryString[null].ToUpper();
                ...
                else if (operation.Equals("REGISTER"))
                {
                    ...
                    try
                    {
                        securityKey = context.Request.QueryString["key"];
                    }
                    catch
                    {
                    }
                ...
                else if (operation.Equals("UNREGISTER"))
                {
                    ...
                    String clientId = context.Request.QueryString["id"];
                ...
                else if (operation.Equals("UNLOAD"))
                {
                    ...
                    String clientId = context.Request.QueryString["id"];
                    String scriptId = context.Request.QueryString["sid"];
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="HttpRemoteGateServer&lt;L&gt;"/> class.
        /// </summary>
        ...
        /// <param name="securityKey">The security key.</param>
        public HttpRemoteGateServer(Int32 threadCount, Int32 port, Int32 timeOut, Int32 uniqueKeySize, String securityKey)
        {
            if (threadCount < 1)
